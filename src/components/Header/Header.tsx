...
export function Header() {
	...
	return (
		<div className="bg-red w-full lg:w-4/5 h-[20%] bg-gradient-to-r from-[#f0405c] to-[#c20831] text-white flex pt-5 relative">
			<MobileMenu className="top-[45%] lg:hidden" />
			<div className="ml-4 font-sans text-lg hidden lg:block">{getHeader(currentLoc)}</div>
